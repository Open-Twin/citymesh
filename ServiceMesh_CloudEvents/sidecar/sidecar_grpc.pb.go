...
type ChatServiceClient interface {
	...
	HealthCheck(ctx context.Context, in *ProtoSchlecht, opts ...grpc.CallOption) (*MessageReply, error)
}
...
func (c *chatServiceClient) HealthCheck(ctx context.Context, in *ProtoSchlecht, opts ...grpc.CallOption) (*MessageReply, error) {
	out := new(MessageReply)
...
type ChatServiceServer interface {
	...
	HealthCheck(context.Context, *ProtoSchlecht) (*MessageReply, error)
...
func (UnimplementedChatServiceServer) HealthCheck(context.Context, *ProtoSchlecht) (*MessageReply, error) {
...
func _ChatService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).HealthCheck(ctx, req.(*ProtoSchlecht))
	}
	return interceptor(ctx, in, info, handler)
}
